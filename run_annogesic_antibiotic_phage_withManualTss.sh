...
optdir="ANNOgesic_antibiotic_phage_withManualTss"
#singularity exec -B `pwd`:`pwd` annogesic.sif annogesic create --project_path $optdir
WIG_FOLDER="ANNOgesic_antibiotic_phage_withManualTss/input/wigs/tex_notex"
...
annogesic optimize_tss_ps \
    ...
    --condition_names Rif HMGU1_Rif Tig HMGU1_Tig --steps 25 \
